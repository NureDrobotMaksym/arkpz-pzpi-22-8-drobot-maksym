...
import { ModeToggle } from "@/app/mode";
...
export default function HomePage() {
  return (
    <>
      <header className="container h-14 flex justify-between items-center border-x">
        <a className="mr-4 flex items-center gap-2 lg:mr-6" href="/">
          ...
          <span className="hidden font-bold lg:inline-block">accesspoint</span>
        </a>
      ...
      <main className="container border-x flex-1"></main>
      <div className="border-t" />
      <footer className="container border-x py-4">
        <div className="text-balance text-center text-sm leading-loose text-muted md:text-left">
          Built by{" "}
          <a
            href="https://twitter.com/sunmadeq"
            target="_blank"
            rel="noreferrer"
          ...
          <a
            href="https://github.com/NureDrobotMaksym/ui"
            target="_blank"
            rel="noreferrer"
            className="font-medium underline underline-offset-4"
          >
